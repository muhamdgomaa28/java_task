...

{
...

    {
        ...
        SynchronizedOutput.displayList(Main.insertbuffer);
...
/////////////second thread class ////////////////////////////
class updateThred extends Thread

{
...

    {
        ...
        SynchronizedOutput.displayList(Main.updatebuffer);

    }

}
class createThred extends Thread

{
...

    {
        ...
        SynchronizedOutput.displayList(Main.createbuffer);
...

{
    ...
    public static synchronized void displayList(StringBuffer name)

    {

        String[] inst = name.toString().split(";");
try {
